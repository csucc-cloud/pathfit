...
export default function Login() {
  ...
  const handleAuth = async (e) => {
    ...
    if (error) {
      ...
      alert(isSigningUp ? "Check your email for a link!" : "Logged in!");
      router.push('/profile');
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#f4f7f9]">
      <div className="fb-card w-full max-w-md p-8 bg-white">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#051e34]">PATHFit Pro</h1>
          <p className="text-[#039be5] font-medium">Student Portal</p>
        </div>
        ...
        <button 
          ...
          className="w-full mt-6 text-sm text-[#039be5] hover:underline"
        >
