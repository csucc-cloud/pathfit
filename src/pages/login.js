    ...
    <div className="min-h-screen bg-[#051e34] flex items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md z-10 transition-all duration-700 ease-out transform">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-[#039be5] rounded-3xl shadow-2xl shadow-[#039be5]/40 mb-6 rotate-3">
        ...
        {/* Login Card */}
        <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl border border-white/10 relative">
          ...
          <form onSubmit={handleAuth} className="space-y-5">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Student Email</label>
              <input
                type="email"
            ...
            >
              {loading ? 'Authenticating...' : (isSigningUp ? 'Register Now' : 'Authorize Access')}
            </button>
          </form>
