    ...
    <RoleGuard allowedRole="instructor">
      <div className="animate-entrance space-y-10">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div>
            ...
            <p className="text-gray-400 font-bold text-xs uppercase tracking-[0.2em] flex items-center gap-2 ml-1">
              <Users className="w-3 h-3 text-fbOrange" /> Managing active class sections
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <h2 className="text-xs font-black text-gray-400 uppercase tracking-[0.3em]">Master Records</h2>
